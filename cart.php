...
body { background:#f4efec; color:#333; min-height:100vh; display:flex; flex-direction:column; }

.navbar { background:#7a1f2b; padding:15px 40px; display:flex; justify-content:space-between; align-items:center; color:white; box-shadow:0 4px 10px rgba(0,0,0,0.1); }
...
.cart-container { max-width:900px; margin:50px auto; padding:0 20px; flex:1; width:100%;}
.cart-header { display:flex; justify-content:space-between; align-items:center; margin-bottom:30px; }
.cart-header h2 { font-family:'Playfair Display', serif; font-size:32px; color:#111; }
.btn-back { display:inline-flex; align-items:center; gap:8px; padding:10px 20px; background:white; color:#555; text-decoration:none; border-radius:30px; font-weight:500; box-shadow:0 3px 8px rgba(0,0,0,0.05); transition:0.3s; }
.btn-back:hover { box-shadow:0 5px 12px rgba(0,0,0,0.1); color:#7a1f2b; }

.cart-card { background:white; border-radius:15px; box-shadow:0 10px 30px rgba(0,0,0,0.05); padding:30px; }
table { width:100%; border-collapse:collapse; }
th, td { padding:15px; text-align:left; border-bottom:1px solid #eee; }
th { color:#777; font-weight:500; font-size:14px; text-transform:uppercase; letter-spacing:1px; }
td { font-weight:500; color:#333; }
.item-name { font-family:'Playfair Display', serif; font-size:18px; color:#111; }

.qty-control { display:inline-flex; align-items:center; background:#f9f9f9; border-radius:8px; border:1px solid #eee; overflow:hidden;}
.qty-btn { text-decoration:none; color:#555; width:30px; height:30px; display:flex; justify-content:center; align-items:center; font-weight:bold; background:white; transition:0.2s; }
.qty-btn:hover { background:#7a1f2b; color:white; }
.qty-val { padding:0 15px; font-weight:600; font-size:15px; }

.btn-remove { color:#e74c3c; text-decoration:none; font-size:14px; font-weight:500; transition:0.2s; }
.btn-remove:hover { color:#c0392b; text-decoration:underline; }

.cart-summary { margin-top:30px; display:flex; flex-direction:column; align-items:flex-end; }
.total-row { display:flex; justify-content:space-between; width:300px; padding:15px 0; border-top:2px solid #eee; }
.total-label { font-size:18px; color:#555; }
.total-amount { font-size:24px; font-weight:600; color:#7a1f2b; }

.btn-checkout { margin-top:20px; width:300px; padding:16px; background:#7a1f2b; color:white; border:none; border-radius:10px; font-size:18px; font-weight:500; cursor:pointer; box-shadow:0 5px 15px rgba(122,31,43,0.3); transition:0.3s; }
.btn-checkout:hover { background:#5c1520; transform:translateY(-2px); box-shadow:0 8px 20px rgba(122,31,43,0.4); }

.empty-state { text-align:center; padding:50px 0; }
.empty-state h3 { font-family:'Playfair Display', serif; font-size:24px; color:#555; margin-bottom:15px; }
.empty-state a { display:inline-block; margin-top:15px; padding:12px 25px; background:#7a1f2b; color:white; text-decoration:none; border-radius:30px; font-weight:500; }
</style>
</head>
<body>
...
<div class="cart-container">
    ...
    <?php if(isset($msg)) echo "<div style='background:#fce8e6; color:#d93025; padding:15px; border-radius:8px; margin-bottom:20px; font-weight:500; text-align:center;'>$msg</div>"; ?>
        ...
        ?>
            <table>
                ...
                <tr>
                    ...
                    <td style="text-align:center;"><a class="btn-remove" href="?remove=<?php echo $item['items_id'];?>">Remove</a></td>
                </tr>
                <?php } ?>
            </table>
