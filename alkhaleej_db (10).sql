...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2026 at 07:59 PM
...
(14, 2, '2026-03-28 08:24:31'),
(18, 1, '2026-03-28 09:55:43'),
(35, 3, '2026-03-28 18:48:20');
...
(1, 'Guest', '7022107987', 'muskaan@gmail.com'),
(2, 'Guest', '9077229981', 'shaharba@gmail.com'),
(3, 'sha', '8722777134', 'sham@gmail.com');
...
INSERT INTO `feedback` (`feedback_id`, `customer_name`, `email`, `rating`, `comments`, `status`, `customer_id`) VALUES
(1, 'shamiya', 'shamiya@gmail.com', 4, 'good', 'approved', 3);
...
CREATE TABLE `orders` (
  ...
  `order_type` enum('dine_in','parcel') DEFAULT 'dine_in',
...
INSERT INTO `orders` (`order_id`, `customer_id`, `reservation_id`, `order_date`, `order_type`, `status`, `total_amount`, `staff_id`) VALUES
(1, 2, NULL, '2026-03-28 03:43:17', 'dine_in', 'completed', 450.00, NULL),
(2, 1, NULL, '2026-03-28 03:55:33', 'dine_in', 'confirmed', 520.00, NULL),
(3, 1, NULL, '2026-03-28 04:13:34', 'dine_in', 'confirmed', 510.00, NULL),
(4, 1, NULL, '2026-03-28 05:17:44', 'dine_in', 'confirmed', 450.00, NULL),
(5, 1, NULL, '2026-03-28 05:19:59', 'dine_in', 'pending', 270.00, NULL),
(6, 3, NULL, '2026-03-28 05:33:05', 'dine_in', 'confirmed', 280.00, NULL),
(7, 3, NULL, '2026-03-28 05:37:43', 'dine_in', 'confirmed', 150.00, NULL),
(8, 3, NULL, '2026-03-28 05:41:21', 'dine_in', 'confirmed', 270.00, NULL),
(9, 3, NULL, '2026-03-28 10:14:06', 'dine_in', 'confirmed', 210.00, NULL),
(10, 3, NULL, '2026-03-28 10:19:18', 'parcel', 'confirmed', 140.00, NULL),
(11, 3, NULL, '2026-03-28 10:23:08', 'dine_in', 'confirmed', 1.00, NULL),
(12, 3, NULL, '2026-03-28 10:27:25', 'dine_in', 'confirmed', 140.00, NULL),
(13, 3, NULL, '2026-03-28 10:28:39', 'dine_in', 'pending', 1.00, NULL),
(14, 3, NULL, '2026-03-28 16:47:00', 'dine_in', 'confirmed', 280.00, NULL),
(15, 3, NULL, '2026-03-28 16:58:03', 'dine_in', 'preparing', 120.00, 2),
(16, 3, NULL, '2026-03-28 17:33:50', 'dine_in', 'pending', 270.00, 2),
(17, 3, NULL, '2026-03-28 18:19:48', 'dine_in', 'confirmed', 270.00, 2),
(18, 3, NULL, '2026-03-28 18:37:14', 'dine_in', 'confirmed', 210.00, 2),
(19, 3, NULL, '2026-03-28 18:43:54', 'dine_in', 'confirmed', 240.00, NULL),
(20, 3, NULL, '2026-03-28 18:47:02', 'dine_in', 'confirmed', 210.00, NULL),
(21, 3, NULL, '2026-03-28 18:48:15', 'dine_in', 'completed', 270.00, 2);
...
INSERT INTO `order_items` (`orderitems_id`, `order_id`, `menu_id`, `quantity`, `price`) VALUES
(19, 1, 18, 1, 210.00),
(20, 1, 10, 1, 240.00),
(21, 2, 12, 1, 280.00),
(22, 2, 10, 1, 240.00),
...
INSERT INTO `payments` (`payment_id`, `order_id`, `customer_id`, `staff_id`, `amount`, `method`, `status`, `payment_date`) VALUES
(1, 17, 3, 2, 270.00, 'Cash', 'Paid', '2026-03-28 18:19:52'),
(2, 18, 3, 2, 210.00, 'Cash', 'Paid', '2026-03-28 18:37:16'),
(3, 19, 3, NULL, 240.00, 'Cash', 'Pending', '2026-03-28 18:43:55'),
(4, 20, 3, NULL, 210.00, 'Cash', 'Pending', '2026-03-28 18:47:05'),
(5, 21, 3, NULL, 270.00, 'Cash', 'Pending', '2026-03-28 18:48:18');
...
(1, 1, '2026-03-29', '19:00:00', 2, 42, 'confirmed'),
(15, 3, '2026-03-03', '00:10:00', 5, 2, 'confirmed'),
(16, 3, '2026-03-03', '02:12:00', 5, 1, 'confirmed'),
(17, 3, '2026-03-03', '05:17:00', 5, 7, 'confirmed');
...
(2, 'Ramesh', 'staff1@gmail.com', 'staff1', '7022107987', 50000.00, 'chef', 'active');
...
ALTER TABLE `payments`
  ...
  ADD KEY `fk_pay_cust` (`customer_id`),
  ADD KEY `fk_pay_staff` (`staff_id`);
...
--
ALTER TABLE `order_items`
  MODIFY `orderitems_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `fk_orders_staff` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`staff_id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
--
ALTER TABLE `payments`
  ADD CONSTRAINT `fk_pay_cust` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_pay_order` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_pay_staff` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`staff_id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `reservation`
--
ALTER TABLE `reservation`
  ADD CONSTRAINT `fk_reservation_customer` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
